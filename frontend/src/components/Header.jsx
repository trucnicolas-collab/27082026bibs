                ...
                {dataset && (
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="h-8 w-48 sm:w-64 pl-8 pr-3 text-sm border border-gray-300 rounded focus:ring-1 focus:ring-[#005BAB] focus:border-[#005BAB] outline-none"
                        />
                    </div>
                )}
                <a
                    ...
                    className="h-8 px-3 bg-slate-900 text-blue-400 text-sm rounded hover:bg-slate-800 flex items-center gap-1.5 transition-colors"
                >
